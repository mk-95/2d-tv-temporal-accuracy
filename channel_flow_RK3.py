...
def error_channel_flow_RK3 (steps = 3,return_stability=False, name='heun', guess=None, project=[],alpha=0.99):
...
# error_channel_flow_RK3 (steps = 2000,return_stability=False, name='regular', guess=None, project=[1,1],alpha=0.99)